...
export default function UserCount() {
  ...
  return (
    <div className=" h-full w-full bg-green-500 *:text-white shadow-lg py-2 rounded-lg px-4">
      <h1 className="font-semibold text-xl pb-4 tracking-wider h-[40%]">
        Total members
      </h1>
      <div className="flex items-center gap-2 py-3">
        <div className="grid grid-cols-2  *:text-white gap-2 text-xl ">
          <div>
            ...
            <span>{members?.ADMIN | 0}</span>
          </div>
          <div>
            <span className="font-semibold">Staff:</span>{" "}
            <span>{members?.STAFF | 0}</span>
          </div>
          <div>
            <span className="font-semibold">Tutor:</span>{" "}
            <span>{members?.TEACHER | 0}</span>
          </div>
          <div>
            <span className="font-semibold">Student:</span>{" "}
            <span>{members?.STUDENT | 0}</span>
          </div>
        </div>
      </div>
    </div>
